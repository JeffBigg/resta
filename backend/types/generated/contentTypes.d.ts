...
export interface ApiPedidoPedido extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    detalle_pedido: Schema.Attribute.JSON;
    direccion_entrega: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pedido.pedido'
    ...
    >;
    status_entrega: Schema.Attribute.Enumeration<
      ['Cocina', 'Listo_para_recoger', 'En_ruta', 'Entregado', 'Cancelado']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiRepartidorRepartidor extends Struct.CollectionTypeSchema {
